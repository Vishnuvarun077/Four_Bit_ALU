...
command = "ngspice Sub_destination.cir"

fp3 = open("Sub_delays.txt", 'w')
fp3.close()
...
'''
    ...
    if i < 4:
        ...
        ReplaceText = "VA3 A3 Gnd PULSE('SUPPLY' 0 0ns 100ps 100ps 20ns 40ns)"
        data = data.replace(SearchText, ReplaceText)

        SearchText = "* Supply for A2"
        ReplaceText = "VA2 A2 Gnd PULSE('SUPPLY' 0 0ns 100ps 100ps 20ns 40ns)"
        data = data.replace(SearchText, ReplaceText)

        SearchText = "* Supply for A1"
        ReplaceText = "VA1 A1 Gnd PULSE('SUPPLY' 0 0ns 100ps 100ps 20ns 40ns)"
        data = data.replace(SearchText, ReplaceText)

        SearchText = "* Supply for A0"
        ReplaceText = "VA0 A0 Gnd PULSE('SUPPLY' 0 0ns 100ps 100ps 20ns 40ns)"
        data = data.replace(SearchText, ReplaceText)
        ...
        SearchText = "* Supply for B3"
        ReplaceText = "VB3 B3 Gnd PULSE('SUPPLY' 0 0ns 100ps 100ps 20ns 40ns)"
        data = data.replace(SearchText, ReplaceText)

        SearchText = "* Supply for B2"
        ReplaceText = "VB2 B2 Gnd PULSE('SUPPLY' 0 0ns 100ps 100ps 20ns 40ns)"
        data = data.replace(SearchText, ReplaceText)

        SearchText = "* Supply for B1"
        ReplaceText = "VB1 B1 Gnd PULSE('SUPPLY' 0 0ns 100ps 100ps 20ns 40ns)"
        data = data.replace(SearchText, ReplaceText)

        SearchText = "* Supply for B0"
        ReplaceText = "VB0 B0 Gnd PULSE('SUPPLY' 0 0ns 100ps 100ps 20ns 40ns)"
        data = data.replace(SearchText, ReplaceText)
    for j in range(0, 4):
        s2 = 'Add_SubS'+str(j)

        fp2 = open("Sub_destination.cir", "w")
        fp3 = open("Sub_delays.txt", "a")
